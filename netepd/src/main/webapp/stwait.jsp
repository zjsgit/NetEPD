...
<body>
	...
	<div class="container main">
		<div class="mainContent">
			...
			<div class="alert alert-warning" style="width: 100%;">
					...
					It may take a long time if you selected several algorithms or uploaded a large network. 
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			//等待一段时间自动链接到下一个页面
			setTimeout(function(){window.location.href = "spatiotemporalRunalgo"}, 1000);
